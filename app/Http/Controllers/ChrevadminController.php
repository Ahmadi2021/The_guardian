...
//        dd($action);
    ...
    {
        $page_title = 'Latest Orders';
        $page_description = 'Some description for the page';

        $action = __FUNCTION__;

        return view('dashboard.orders.latestorders', compact('page_title', 'page_description','action'));
    }
    // Completed Orders
    public function completed_orders()
    {
        ...
        $action = __FUNCTION__;
            ...
            return view('dashboard.orders.completedorders', compact('page_title', 'page_description','action'));
    }
    // pending orders
    public function pending_orders()
    {
        ...
        $action = __FUNCTION__;
            ...
            return view('dashboard.orders.pendingorders', compact('page_title', 'page_description','action'));
    }
        // inprocess orders
        public function inprocess_orders()
        {
            $page_title = 'Inprocess Orders';
            $page_description = 'Some description for the page';
             
            $action = __FUNCTION__;
             
                return view('dashboard.orders.inprocessorders', compact('page_title', 'page_description','action'));
        }
        // Register Manager
    public function register_manager()
    {
        ...
        return view('dashboard.managers.register', compact('page_title', 'page_description','action'));
    }
          // List Managers
          public function list_managers()
          {
              ...
              return view('dashboard.managers.list', compact('page_title', 'page_description','action'));
          }
          // List Writers
          public function list_writers()
          {
              $page_title = 'Writers List';
              $page_description = 'Some description for the page';
               
              $action = __FUNCTION__;
               
              return view('dashboard.writers.list', compact('page_title', 'page_description','action'));
          }
          // Register Writers
          public function register_writer()
          {
              $page_title = 'Add Writer';
              $page_description = 'Some description for the page';
               
              $action = __FUNCTION__;
               
              return view('dashboard.writers.register', compact('page_title', 'page_description','action'));
          }
