...
Route::get('orders-{status}', [\App\Http\Controllers\Orders\OrderStatusController::class, 'index'])->name('orders.status');
Route::resource('drafts', \App\Http\Controllers\DraftsController::class);
Route::resource('revisions', \App\Http\Controllers\RevisionController::class);

//Route::get('/orders-latest', 'App\Http\Controllers\ChrevadminController@latest_orders')->name('orders.latest');
//Route::get('/orders-completed', 'App\Http\Controllers\ChrevadminController@completed_orders');
//Route::get('/orders-pending', 'App\Http\Controllers\ChrevadminController@pending_orders')->name('orders.pending');
//Route::get('/orders-inprocess', 'App\Http\Controllers\ChrevadminController@inprocess_orders');
...
Route::get('/add-writer', 'App\Http\Controllers\ChrevadminController@register_writer');
Route::get('/writers-list', 'App\Http\Controllers\ChrevadminController@list_writers');
