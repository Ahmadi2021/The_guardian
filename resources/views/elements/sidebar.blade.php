<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li>
                        <a class="ai-icon" href="{!! url('/index'); !!}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                    </li>
                    <li class="{{auth()->user()->hasRole('customer') ? 'mm-active' : ''}}"><a class="has-arrow ai-icon" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{!! url('/orders-processing'); !!}">In-Process</a></li>
                            <li><a href="{!! url('/orders-on-hold'); !!}">On-Hold</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('drafts.index')}}">All Drafts</a></li>
                            <li><a href="{{route('drafts.create')}}">Create Create</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('revisions.index')}}">All Revisions</a></li>
                            <li><a href="{{route('revisions.create')}}">Create Revision</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('managers.index')}}">All Managers</a></li>
                            <li><a href="{{route('managers.create')}}">Create Manager</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="#" aria-expanded="false">
							<i class="flaticon-381-user"></i>
							<span class="nav-text">Writers</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('writers.index')}}">All Writers</a></li>
                            <li><a href="{{route('writers.create')}}">Create Writer</a></li>
                        </ul>
...
{{--					<p><strong>The Guardian Portal</strong> © 2021 All Rights Reserved</p>--}}
{{--					<p>Made with <i class="fa fa-heart"></i> by HA-Technologies</p>--}}
{{--				</div>--}}
			</div>
        </div>
