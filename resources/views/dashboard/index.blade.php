			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-4 mb-md-5 align-items-start">
					...
					@if(auth()->user()->hasRole('admin'))
                        <a href="{{route('managers.create')}}" class="btn btn-primary ml-auto">+ Add New Manager</a>
                    @elseif(auth()->user()->hasRole('manager'))
                        <a href="{{route('writers.create')}}" class="btn btn-primary ml-auto">+ Add New Writer</a>
                    @elseif(auth()->user()->hasRole('writer'))
                        <a href="{{route('orders.latest')}}" class="btn btn-primary ml-auto">Latest Orders</a>
                    @else
                        <a href="{{route('orders.create')}}" class="btn btn-primary ml-auto">+ Add New Order</a>
