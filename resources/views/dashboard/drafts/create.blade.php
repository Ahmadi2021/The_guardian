    ...
    <div class="row page-titles">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Add new Draft </a> </li>
            </ol>
        </div>
    </div>
    <!-- row -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Draft</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <select type="text" class="form-control @error('title') is-invalid @enderror" name="id" required>
